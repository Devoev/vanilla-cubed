...
enum class ModArmorMaterials(
    ...
    ANCIENT_GOLD(name = "ancient_gold", enchantability = 50, durabilityMultiplier = 30, equipSound = SoundEvents.ITEM_ARMOR_EQUIP_GOLD, repairItem = { ModItems.ANCIENT_GOLD_INGOT }),
