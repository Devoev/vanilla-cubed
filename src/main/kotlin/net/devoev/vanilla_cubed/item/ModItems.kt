...
import net.devoev.vanilla_cubed.materials.AncientGoldArmorMaterial
...
object ModItems : RegistryManager<Item>(Registry.ITEM) {
    ...
    val ANCIENT_GOLD_CHESTPLATE = create("ancient_gold_chestplate", ArmorItem(AncientGoldArmorMaterial, EquipmentSlot.CHEST, FabricItemSettings().group(ItemGroup.COMBAT)))
