 ...
 */
val BerserkModifier = armorStatusEffectModifierOf(StatusEffects.STRENGTH, 100, 1) runIf
        { _, _, _, entity, _, _ -> entity.isOnFire }

//val BERSERK_TEXT: Text = translatableTextOf("modifier", "berserk").formatted(Formatting.BLUE)
val BERSERK_TEXT: Text = toolStatusEffectTextOf(StatusEffects.STRENGTH, "II")
